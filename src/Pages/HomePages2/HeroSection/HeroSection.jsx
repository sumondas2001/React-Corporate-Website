...
const HeroSection = () => {
     ...
     return (
          <div className="mb-20 mt-10 relative bg-cyan-100 lg:pl-10 md:pl-6 pl-3">
               <div className="flex justify-between items-center">

                    <div className="lg:space-y-6 md:space-y-3 space-x-2 "
                         data-aos="fade-up"
                    ...
                    >
                         ...
                         <h1 className="lg:text-3xl md:text-xl text-xs font-bold">Grow Your Business More Efficiently</h1>
                         <p className="lg:text-lg md:text-sm text-xs font-medium">Agilos helps you to convert your data into a strategic asset and get top-notch business insights.</p>
                    ...
                    <img
                         ...
                         className="object-cover  lg:h-[500px] md:h-[350px]  rounded-bl-full lg:w-[900px] w-40 md:w-[400px]" src={imgUrl} alt="" />
               </div>
